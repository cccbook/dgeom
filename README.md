...
* [test_minkowski.py](test_minkowski.py) ： 狹義相對論『閩可夫斯基空間』範例
    * 數學原理 -- https://gemini.google.com/share/1f70c33d6a06
* [test_murcury_procession.py](test_murcury_procession.py) ：廣義相對論『水星進動』範例
    * 數學原理 -- https://gemini.google.com/share/9a7c48879a1a
* [test_black_hole.py](test_black_hole.py) ：廣義相對論『黑洞』範例
...
* [test_schwarzschild_de_sitter.py](test_schwarzschild_de_sitter.py) ： 廣義相對論 SdS 度規範例
    * 數學原理 -- https://gemini.google.com/share/10ac77736c53
* [test_riemann.py](test_riemann.py) ：微分幾何範例（度規）
    * 數學原理 -- https://gemini.google.com/share/de0e3b5ee633
* [test_dvector.py](test_dvector.py) : 向量微積分範例（含外微分與廣義史托克定理）(使用 sympy 實作)
    * 數學原理 -- https://gemini.google.com/share/66966e45f718

以下使用 dgeom.num 套件 (背後是 numpy)

* [test_num_dvector.py](test_num_dvector.py) ：向量微積分範例（含外微分與廣義史托克定理）
